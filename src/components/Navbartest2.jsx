          ...
          <div className={`flex justify-between items-center transition-all duration-300 ${
            ...
            <div className="xl:hidden">
              <button 
                ...
                className={`inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:text-blue-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 transition-all duration-300 ${
                  isScrolled ? 'scale-90' : 'scale-100'
                }`}
