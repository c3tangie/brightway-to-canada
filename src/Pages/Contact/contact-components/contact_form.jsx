        ...
        <div class="max-w-3xl mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
          ...
          <div class="m-7">
            <form className='mt-5 max-w-screen-2xl mx-auto 2xl:px-20 xl:px-20 px-6 font-RobotoFlex text-center text-xl leading-normal' onSubmit={onSubmit}>
                ...
                <div class="mb-6">
                  <button type="reset" ononclick="return confirm('Reset The Form?');" class="w-full px-3 py-4 text-white bg-indigo-900 rounded-md active:bg-blue-800 focus:outline-none transition-colors duration-100">
                    Reset
                  </button>
                </div>

                <div class="mb-6">
                  <button type="submit" ononclick="return confirm('Submit The Form?');" class="w-full px-3 py-4 text-white bg-indigo-900 rounded-md active:bg-blue-800 focus:outline-none transition-colors duration-100">
                    Send Message
                  </button>
                </div>
            </form>
